...
где branch_name - это название ветки, в которую необходимо переместиться

## Слияние веток

Слияние необходимо для переноса проекта(части проекта) из отдельной ветки в основную (master) 
...
При проведении слияния необходимо перейти в ту ветку **куда** будет производиться слияние, а после комманды merge указать название ветки **откуда** будет браться информация для слияния.

## Удаление ветки после слияние